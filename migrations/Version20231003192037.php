 ...
 */
final class Version20231003192037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, nom VARCHAR(255) NOT NULL, instruction LONGTEXT NOT NULL, nbre_pers INT DEFAULT NULL, tps_cuisson TIME DEFAULT NULL, image_recette VARCHAR(255) DEFAULT NULL, id_recipe VARCHAR(255) NOT NULL, INDEX IDX_DA88B13712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
